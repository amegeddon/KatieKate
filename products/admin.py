...
class ProductAdmin(admin.ModelAdmin):
    ...
    This class customizes how Product instances are displayed in /
    the Django admin interface, including which fields to display /
...
class CategoryAdmin(admin.ModelAdmin):
    ...
    This class customizes how Category instances are displayed /
    in the Django admin interface, including which fields to display /
...
class SpecialOfferAdmin(admin.ModelAdmin):
    ...
    This class customizes how SpecialOffer instances are displayed /
    in the Django admin interface, including the search fields.
    """
